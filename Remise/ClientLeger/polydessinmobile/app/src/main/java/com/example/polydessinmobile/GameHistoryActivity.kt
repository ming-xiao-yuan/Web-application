...
class GameHistoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ServerRequest().getGameHistory(object: MyCallBackGameHistoryItemList {
            override fun onCallBack(value: MutableList<GameHistoryItem>) {
                recycler_view_game.adapter = GameHistoryAdapter(value) // Prend en paramètre un List<GameHistoryItem>
                recycler_view_game.layoutManager = LinearLayoutManager(theThis)
                recycler_view_game.setHasFixedSize(true)
            }
        })
    ...
    private fun chatPopUp(inflater: LayoutInflater) {
        chat_button_popup_game_history.setOnClickListener {
            ...
            TransitionManager.beginDelayedTransition(activity_game_history)
            popupWindow.showAtLocation(
                    activity_game_history,
                    Gravity.CENTER,
                    0,
                    0)
        }
    ...
    private fun showNotification(){
        notification_popup_game_history.visibility = View.VISIBLE
    }

    private fun hideNotification(){
        notification_popup_game_history.visibility = View.GONE
    }
