...
@Component({
    selector: 'app-add-channel-are-you-sure',
    templateUrl: './add-channel-are-you-sure.component.html',
    styleUrls: ['./add-channel-are-you-sure.component.scss'],
})
export class AddChannelAreYouSureComponent implements OnInit {
    avatar: string;
